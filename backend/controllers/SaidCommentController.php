...
use backend\models\SaidCommentSearch;
...
class SaidCommentController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new SaidComment",
                    'content'=>'<span class="text-success">Create SaidComment success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing SaidComment model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing SaidComment model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {        
        ...
        foreach (SaidComment::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }
