...
use backend\models\SaidTagSearch;
...
class SaidTagController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new SaidTag",
                    'content'=>'<span class="text-success">Create SaidTag success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing SaidTag model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing SaidTag model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {        
        ...
        foreach (SaidTag::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }
